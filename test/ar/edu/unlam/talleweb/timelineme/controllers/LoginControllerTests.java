...
public class LoginControllerTests {
	...
	public void authTest() throws Exception {
		...
		ModelAndView modelAndView = controller.authenticate("username", "password");

		Assert.assertEquals("welcome", modelAndView.getViewName());
		Assert.assertEquals("Bienvenido, @username", modelAndView.getModel().get("message"));
	...
	public void authRefusedTest() throws Exception {
		...
		LoginController controller = new LoginController();
		ModelAndView modelAndView = controller.authenticate("baduser", "badpassword");
